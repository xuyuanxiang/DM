 ...
 * of this value object you may modify the generated sub-class of this class - Log.as.
 */
...
[ExcludeClass]
public class _Super_Log extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("name.xuyuanxiang.model.Log") == null)
            {
                flash.net.registerClassAlias("name.xuyuanxiang.model.Log", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _LogEntityMetadata;
    ...
    public function _Super_Log()
    {
        _model = new _LogEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _LogEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _LogEntityMetadata) : void
    {
        var oldValue : _LogEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
