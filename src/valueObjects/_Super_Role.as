 ...
 * of this value object you may modify the generated sub-class of this class - Role.as.
 */
...
[ExcludeClass]
public class _Super_Role extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("name.xuyuanxiang.model.Role") == null)
            {
                flash.net.registerClassAlias("name.xuyuanxiang.model.Role", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _RoleEntityMetadata;
    ...
    public function _Super_Role()
    {
        _model = new _RoleEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _RoleEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _RoleEntityMetadata) : void
    {
        var oldValue : _RoleEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
