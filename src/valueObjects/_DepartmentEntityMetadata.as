...
internal class _DepartmentEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("id", "levels", "name", "children", "parent", "code", "groups");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array();
    model_internal static var allAlwaysAvailableProperties:Array = new Array("id", "levels", "name", "children", "parent", "code", "groups");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("id", "levels", "name", "children", "parent", "code", "groups");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("id", "levels", "name", "children", "parent", "code", "groups");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array("children", "groups");
    ...
    public function _DepartmentEntityMetadata(value : _Super_Department)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["levels"] = new Array();
            ...
            model_internal::collectionBaseMap["children"] = "valueObjects.Department";
        ...
        model_internal::propertyTypeMap["levels"] = "Number";
        model_internal::propertyTypeMap["name"] = "String";
        model_internal::propertyTypeMap["children"] = "ArrayCollection";
        model_internal::propertyTypeMap["parent"] = "valueObjects.Department";
    ...
    [Bindable(event="propertyChange")]
    public function get isLevelsAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get levelsStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
