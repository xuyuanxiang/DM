...
public class _Super_Root extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("name.xuyuanxiang.model.Root") == null)
            {
                flash.net.registerClassAlias("name.xuyuanxiang.model.Root", cz);
            }
        }
        catch (e:Error)
        {
    ...
    private var _internal_absolutePath : String;
    ...
    {
        var oldValue:String = _internal_absolutePath;
        if (oldValue !== value)
        {
            _internal_absolutePath = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "absolutePath", oldValue, _internal_absolutePath));
        }
    }
