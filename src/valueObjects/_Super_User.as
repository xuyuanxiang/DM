...
public class _Super_User extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("name.xuyuanxiang.model.User") == null)
            {
                flash.net.registerClassAlias("name.xuyuanxiang.model.User", cz);
            }
        }
        catch (e:Error)
        {
     ...
     * properties
     */
    private var _internal_superior : valueObjects.User;
    private var _internal_lockflag : Number;
    private var _internal_status : Number;
    ...
    private var _internal_defaultDepartment : valueObjects.Department;
    ...
    public function get superior() : valueObjects.User
    {
        return _internal_superior;
    }

    [Bindable(event="propertyChange")]
    public function get lockflag() : Number
    {
        return _internal_lockflag;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get defaultDepartment() : valueObjects.Department
    {
        return _internal_defaultDepartment;
    }
    ...
    public function set superior(value:valueObjects.User) : void
    {
        var oldValue:valueObjects.User = _internal_superior;
        if (oldValue !== value)
        {
            _internal_superior = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "superior", oldValue, _internal_superior));
        }
    }

    public function set lockflag(value:Number) : void
    {
        var oldValue:Number = _internal_lockflag;
        if (oldValue !== value)
        {
            _internal_lockflag = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "lockflag", oldValue, _internal_lockflag));
        }
    }

    public function set status(value:Number) : void
    {
        var oldValue:Number = _internal_status;
        if (oldValue !== value)
        {
    ...
    public function set defaultDepartment(value:valueObjects.Department) : void
    {
        var oldValue:valueObjects.Department = _internal_defaultDepartment;
        if (oldValue !== value)
        {
            _internal_defaultDepartment = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "defaultDepartment", oldValue, _internal_defaultDepartment));
        }
    }
